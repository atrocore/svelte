<script lang="ts">
    ...
    import FilterSearch from "$lib/components/search/FilterSearch/FilterSearch.svelte";
    import SearchBar from "$lib/components/search/SearchBar/SearchBar.svelte";
    import { Notifier } from "$lib/core/notifier";
    import type Counter from "$lib/components/containers/toolbar/types/counter";
    import type MassAction from "$lib/components/containers/toolbar/types/mass-action";
