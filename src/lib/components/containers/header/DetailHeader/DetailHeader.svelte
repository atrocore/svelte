<script lang="ts">
    ...
    import type AnchorNavItem from "$lib/components/containers/header/AnchorNavigation/types/anchor-nav-item";
    ...
    import type RecordActionButtons from "$lib/components/containers/header/types/record-actions-buttons";
    import RecordActionsGroup from "$lib/components/containers/header/RecordActionsGroup/RecordActionsGroup.svelte";
    import type RecordCallbacks from "$lib/components/containers/header/types/record-callbacks";
