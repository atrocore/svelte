...
<script lang="ts">
    ...
    import CombinedIntEdit from './CombinedIntEdit/CombinedIntEdit.svelte';
    import CombinedIntDetail from './CombinedIntDetail/CombinedIntDetail.svelte';
    import CombinedIntList from './CombinedIntList/CombinedIntList.svelte';
    ...
    let editComponent: CombinedIntEdit | undefined;
...
{#if mode === 'edit'}
    ...
    />
{:else if mode === 'detail'}
    <CombinedIntDetail {value} {prefixLabel} {unitSymbol} {isFormat2} />
{:else if mode === 'list'}
    <CombinedIntList {value} {prefixLabel} {unitSymbol} {isFormat2} />
