<script lang="ts">
    ...
    import QueryBuilder from "$lib/components/search/QueryBuilder/QueryBuilder.svelte";
    import DataQualityPanel from "$lib/components/right-panels/DataQualityPanel/DataQualityPanel.svelte";
